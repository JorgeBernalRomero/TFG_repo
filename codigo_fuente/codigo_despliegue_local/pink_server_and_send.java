package PinkNodeEdeliveryPackage;
...
public class pink_server_and_send implements MessageListener{
	...
	public static void starting(){
		try{
            ...
            consumer.setMessageListener((MessageListener) new pink_server_and_send());
	...
	public static void sending(Session session){
		try{
			...
			File file = new File("/Users/jorgebernalromero/Documents/INGENIERIA_INFORMATICA/Cuarto_uni/Segundo_cuatri/TFG/ficheros_comunicacion/pinkNode/dir_destino_prueba/outScriptPink.txt"); //directorio puede modificarse o por parámetro???
    ...
    public void onMessage(Message msg) {
        try {
			...
			if (msg instanceof MapMessage) {
				...
				String saveDirectory = "/Users/jorgebernalromero/Documents/INGENIERIA_INFORMATICA/Cuarto_uni/Segundo_cuatri/TFG/ficheros_comunicacion/pinkNode/dir_destino_prueba"; //esta parte se podría sustituir pasando el dirDestino por parámetro
        		...
        		try {
        			ProcessBuilder processBuilder = new ProcessBuilder("/bin/bash", "/Users/jorgebernalromero/Documents/INGENIERIA_INFORMATICA/Cuarto_uni/Segundo_cuatri/TFG/ficheros_comunicacion/pinkNode/dir_destino_prueba/payload_1"); //El directorio podría pasarse por parámetro
