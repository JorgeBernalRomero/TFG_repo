...
public class pink_server_and_send implements MessageListener{
	...
	public static void starting(){
		try{
			ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://1.44.4.92:61616");
	...
	public static void sending(Session session){
		try{
			...
			messageMap.setStringProperty("fromPartyId", "domibus-pink");
			...
			File file = new File("/Users/jorgebernalromero/Documents/INGENIERIA_INFORMATICA/Cuarto_uni/Segundo_cuatri/TFG/ficheros_comunicacion/pinkNode/dir_destino_prueba/outScriptPink.txt");
    ...
    public void onMessage(Message msg) {
        try {
			...
			if (msg instanceof MapMessage) {
				...
				String saveDirectory = "/Users/jorgebernalromero/Documents/INGENIERIA_INFORMATICA/Cuarto_uni/Segundo_cuatri/TFG/ficheros_comunicacion/pinkNode/dir_destino_prueba";
        		...
        		try {
        			ProcessBuilder processBuilder = new ProcessBuilder("/bin/bash", "/Users/jorgebernalromero/Documents/INGENIERIA_INFORMATICA/Cuarto_uni/Segundo_cuatri/TFG/ficheros_comunicacion/pinkNode/dir_destino_prueba/payload_1");
